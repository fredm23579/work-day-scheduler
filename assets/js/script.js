$(function () {
    ...
    function displayCurrentDate() {
        ...
        let formattedDate = date.format('dddd, MMMM ') + day + suffix; // Format the date in the format "dddd, MMMM Dth" where th is the suffix using Day.js library and assign it to formattedDate variable
